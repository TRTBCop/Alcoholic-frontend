...
const AlcoholHistoryWriteForm: React.FC = () => {
  ...
  return (
    <article className={styles.hs_write_form}>
      <section className={styles.hs_write_drunked_date}>
        <h3>음주일자</h3>
        <div className={styles.hs_write_date_content}>
      ...
      <section className={styles.hs_write_drunked_type}>
        <h3>음주 종류</h3>
        <div className={styles.hs_write_drunked_content}>
          <div className={styles.hs_write_drunked_added_item}>
            <figure className={styles.hs_write_drunked_added_img}>
            ...
            <ul className={styles.hs_write_drunked_added_content}>
              <li>
          ...
          <div className={styles.hs_write_drunked_add_btn}>
            <button>
      ...
      <section className={styles.hs_write_drunked_memo}>
        <h3>메모 내용</h3>
        <div className={styles.hs_write_memo_content}>
          <textarea name="hs_write_memo" id="hs_write_memo" cols={50} rows={10} placeholder="간단한 메모 내용을 작성해주세요."></textarea>
        </div>
      </section>
      <section className={styles.hs_write_btn}>
        <button className="btn_type_2">작성완료</button>
      </section>
      <Link
        href={{
      ...
      >
        <button className="btn_type_3">목록</button>
      </Link>
    </article>
  );
};
